...
a persistence unit "GuapanPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Guapan\pom.xml":
...
artifact ("Guapan.war") is already built. You can build
